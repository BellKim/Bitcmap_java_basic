			...
			<div id="login_wrap">
				<form action="loginAf.do" name="frmForm" id="_frmForm" method="post">
					<table class="content_table" style="width:75%">
						...
						<tbody>
							<tr>
								<th style="background:#eeeeee; color:#3e5fba"> id 아이디 </th>
								<td > 
									&nbsp;
									<input type="text" id="_userid" name="id" data-msg="ID를 입력해주세요" size="20px" title="아이디" style="border:1px solid #dddddd;">
							...
							<tr>
								...
								<td> 
									&nbsp;
									<input type="password" id="_pwd" name="pwd" data-msg="pwd를 입력해주세요" size="20px" title="패스워드" style="border:1px solid #dddddd;">
								</td>
							</tr>
							<tr>
	...
	$("#chk_save_id").click(function(){
		if($("#chk_save_id").is(":checked")){
			if($("#_userid").val().trim()==""){
				...
				$.cookie("user_id", $("#_user_id").val(), {expires:356, path:'/'});
			}
