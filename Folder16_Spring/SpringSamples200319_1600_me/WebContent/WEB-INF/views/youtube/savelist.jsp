...
<div id="_youtube_">
	<iframe id="_youtube" width="640" height="360"
		src="http://www.youtube.com/embed/" frameborder="0" allowfullscreen>
	</iframe>
</div>
...
<thead>
	<tr>
		<th>번호</th><th>제목</th><th>유튜브 고유번호</th><th>삭제</th>
	</tr>
</thead>
...
<tr class="_hover_tr">
	...
	<td onclick="getyoutube('${login.id}', '${you.vname }')">
		<img alt="" src="image/del.png" class="ck_seq" vname='${you.vname }' id='_v${you.vname }ed'
