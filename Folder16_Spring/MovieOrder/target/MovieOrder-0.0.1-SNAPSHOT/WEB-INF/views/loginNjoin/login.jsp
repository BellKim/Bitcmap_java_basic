...
<div class="loginBox">
	<form action="loginCheck.do" method="get">
		<ul>
			<li>
				<!-- 아이디 입력 -->
				<input class="textBox" type="text" name="id" placeholder="아이디를 입력해주세요">
			</li>
			<li>
				<!-- 비밀번호 입력 -->
				<input class="textBox" type="password" name="pwd" placeholder="비밀번호를 입력해주세요">
			</li>
			<li>
				<!-- 아이디 찾기 버튼 -->
				<a href=findid.jsp class="findId">아이디 찾기</a> | <a href=findpassword.do>비밀번호 찾기</a> 
			...
			<li>
				<!-- 가입하기 버튼 -->
				<button class="joinBtn" type="button" onclick="location.href='join.do'">가입하기</button>
			</li>	
		</ul>
	</form>
</div>
